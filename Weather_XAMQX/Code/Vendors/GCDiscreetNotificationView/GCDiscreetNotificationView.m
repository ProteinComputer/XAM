...
- (void) drawRect:(CGRect)rect {
    ...
    CGContextSetFillColorWithColor(context, [UIColor getColorWithRed:0 andGreen:187 andBlue:156].CGColor);
    CGContextSetStrokeColorWithColor(context, [UIColor getColorWithRed:0 andGreen:187 andBlue:156].CGColor);
